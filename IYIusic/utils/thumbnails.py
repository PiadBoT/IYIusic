...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("IYIusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("IYIusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("IYIusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("IYIusic/assets/play_icons.png")
